...
# NOTE: no default is provided on purpose; the value must come from the runtime environment
export FINERACT_HIKARI_PASSWORD="${FINERACT_HIKARI_PASSWORD:?FINERACT_HIKARI_PASSWORD must be set in the environment}"
...
export FINERACT_DEFAULT_TENANTDB_PWD="${FINERACT_DEFAULT_TENANTDB_PWD:?FINERACT_DEFAULT_TENANTDB_PWD must be set in the environment}"
export FINERACT_DEFAULT_TENANTDB_MASTER_PASSWORD="${FINERACT_DEFAULT_TENANTDB_MASTER_PASSWORD:?FINERACT_DEFAULT_TENANTDB_MASTER_PASSWORD must be set in the environment}"
...
export FINERACT_DEFAULT_MASTER_PASSWORD="${FINERACT_DEFAULT_MASTER_PASSWORD:?FINERACT_DEFAULT_MASTER_PASSWORD must be set in the environment}"
export FINERACT_SERVER_SSL_KEY_STORE_PASSWORD="${FINERACT_SERVER_SSL_KEY_STORE_PASSWORD:?FINERACT_SERVER_SSL_KEY_STORE_PASSWORD must be set in the environment}"
